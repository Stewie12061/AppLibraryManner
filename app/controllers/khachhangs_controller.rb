class KhachhangsController < ApplicationController
  ...
  # GET /khachhangs/1 or /khachhangs/1.json
  def show
  end
  ...
  def create
    ...
    respond_to do |format|
      if @khachhang.save
        format.html { redirect_to khachhang_url(@khachhang), notice: "Khachhang was successfully created." }
  ...
  def update
    respond_to do |format|
      if @khachhang.update(khachhang_params)
        format.html { redirect_to khachhang_url(@khachhang), notice: "Khachhang was successfully updated." }
  ...
  private
    ...
    def khachhang_params
      params.require(:khachhang).permit(:stt, :tenkh, :makh, :diachi, :email, :ngaysinh, :tongno, :loaikh)
    end
end
